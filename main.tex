...
\begin{frame}{Git vs Subversion y otros 1/2}
    ...
    \begin{figure}[ht]
        \begin{center}
            \includegraphics[height=1.5in]{images/data.png}
        \end{center}
    \end{figure}
...
\begin{frame}{Comprobando el estado de tus archivos}
    ...
    \begin{figure}[ht]
        \begin{center}
            \includegraphics[height=1in]{images/lifecycle.png}
        \end{center}
    \end{figure}
...
\begin{frame}{Ramificaciones en Git}
    ...
    \begin{columns}
        ...
        \begin{figure}[ht]
            \begin{center}
                \includegraphics[height=1.1in]{images/history.png}
            \end{center}
        ...
        \begin{figure}[ht]
            \begin{center}
                \includegraphics[height=1.1in]{images/master.png}
            \end{center}
...
\begin{frame}{Cambiando de rama}
    ...
    \begin{figure}[ht]
        \begin{center}
            \includegraphics[height=1in]{images/testing.png}
        \end{center}
...
\begin{frame}{Fusionando ramas}
	...
	\begin{figure}[ht]
		\begin{center}
			\includegraphics[height=1.5in]{images/merging-1.png}
		\end{center}
...
\begin{frame}{Fusionando ramas}
	...
	\begin{figure}[ht]
		\begin{center}
			\includegraphics[height=1.5in]{images/merging-2.png}
		\end{center}
